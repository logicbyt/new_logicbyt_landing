            ...
            <div className="flex gap-3">
              {siteConfig.contact.social.map((social, index) => (
                <a
                  ...
                  className="w-9 h-9 rounded-lg bg-white/5 flex items-center justify-center text-white/40 hover:text-accent hover:bg-white/10 transition-all duration-300"
